...
class GoogleWorkspacePage(BasePage):
    def __init__(self, page):
        ...
        self.__create_account_btn = page.get_by_role("button", name="Create account")
        self.__create_personal_account = page.get_by_role("menuitem", name="For my personal use")
